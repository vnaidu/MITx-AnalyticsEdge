...
The proportion of the time the model can differentiate between a randomly selected month during which the federal funds were raised and a randomly selected month during which the federal funds were not raised  The proportion of the time the model correctly identifies whether or not federal funds were raised
